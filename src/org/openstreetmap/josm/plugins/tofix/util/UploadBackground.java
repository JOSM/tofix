...
import static org.openstreetmap.josm.actions.JosmAction.getEditLayer;
 ...
 * @author samely
 */
public class UploadBackground extends JosmAction {
     ...
     * @param comment
     */
    public void uploadData(final OsmDataLayer layer, APIDataSet apiData, final String comment) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                Main.map.mapView.getEditLayer().data.getChangeSetTags().put("comment", comment);
        ...
        dialog.getChangeset().put("comment", comment);
        dialog.getChangeset().put("source", dialog.getLastChangesetSourceFromHistory());
